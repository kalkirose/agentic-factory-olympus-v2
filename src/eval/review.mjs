...
function roleBlock({ review, window, last, paths }) {
  ...
  return [
    ...
    'Four tripwire metrics read the same ledgers you are reading, and their ids',
    ...
    'person) and `allowlist-findings-window` (confirmed spec-lens findings on a',
    ...
    'a lens nobody is feeding, not a clean window).',
