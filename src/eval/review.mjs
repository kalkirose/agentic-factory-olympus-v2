...
function roleBlock({ review, window, last, paths }) {
  ...
  return [
    ...
    'and, in the ship lane, `merge-conflict`. Every fresh pass stands on one of',
    'them, so a window whose passes come from one reason is a window naming the',
    'step that stops working. A finding about the shape of the implementation',
    'takes a repair round like any other finding and buys no pass of its own.',
